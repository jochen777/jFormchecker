...
public class ExampleForm extends FormCheckerForm {
  ...
  public void init() {
    ...
    add(TextInput.build("firstname").setDescription("Your Firstname").setPreSetValue("Peter")
        .setRequired().setHelpText("Andreas")
    ...
    add(DateInputSelectCompound.build("date", YearRange.aroundYear(2018, 5))
    ...
    add(LongTextInput.build("description").setPlaceholerText("areaplaceholder").setRequired()
