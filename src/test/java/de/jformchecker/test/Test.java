...
public class Test {
  ...
  public void testXSS() {
    ...
    assertEquals(
        "<input  id=\"form_firstname\"   class=\"\" tabindex=\"0\" type=\"text\" name=\"firstname\" value=\"Jochen Pier&lt;bold&gt;\">",
        inputTag);
  }
  ...
  public void testPrefillText() {
    ...
    String inputTag = ti.getInputTag();
    assertEquals("<input  id=\"form_firstname\"   class=\"\" tabindex=\"0\" type=\"text\" name=\"firstname\" value=\"Jochen\">",
        inputTag);
  }
